...
import { imgClarakProfile2 } from "./svg-3a1nz";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-end justify-center left-[524px] top-[102px] w-[611px]">
      <Intro />
      <UserResponse />
      <div className="basis-0 font-['Roboto_Slab:Regular',sans-serif] font-normal grow leading-[1.25] min-h-px min-w-full relative shrink-0 text-[#2d6383] text-[16px] tracking-[-0.48px] w-[min-content]">
