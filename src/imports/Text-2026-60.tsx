export default function Text() {
  return (
    <div className="bg-white leading-[1.25] relative size-full" data-name="Text">
      <p className="absolute font-['Caveat:Bold',sans-serif] font-bold left-[187px] text-[#2e2e2e] text-[40px] top-[43px] tracking-[1.6px] w-[662px]">This is an H1 tag</p>
      <p className="absolute font-['Roboto_Slab:Bold',sans-serif] font-bold left-[187px] text-[#2e2e2e] text-[40px] top-[102px] tracking-[1.6px] w-[662px]">This is an H2 tag</p>
      ...
      <p className="absolute font-['Roboto:Regular',sans-serif] font-normal left-[187px] text-[#2e2e2e] text-[16px] top-[287px] tracking-[-0.48px] w-[662px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        This is an example of body text (user input)
      </p>
      <p className="absolute font-['Roboto_Slab:Regular',sans-serif] font-normal left-[174px] text-[#2e2e2e] text-[16px] top-[342px] tracking-[-0.48px] w-[662px]">This is an example of an H3 tag (voice of the AI?)</p>
