...
import { imgClarakProfile2 } from "./svg-dxy3b";

function Intro() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[611px]" data-name="Intro">
      <p className="font-['Roboto_Slab:Medium',sans-serif] font-medium leading-[1.25] relative shrink-0 text-[#2d6383] text-[18px] tracking-[-0.54px] w-full">Hi, my name is Clara. I’m good at making complex data feel friendly.</p>
...
function UserResponse() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[10px] items-center justify-end p-[10px] relative rounded-bl-[12px] rounded-br-[12px] rounded-tl-[12px] shrink-0" data-name="User response">
      <div className="flex flex-col font-['Roboto:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#2e2e2e] text-[18px] text-nowrap text-right tracking-[-0.54px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[27px] items-end justify-center left-[524px] top-[102px] w-[611px]">
      <Intro />
      <UserResponse />
      <div className="font-['Roboto_Slab:Medium',sans-serif] font-medium leading-[1.25] min-w-full relative shrink-0 text-[18px] text-black tracking-[-0.54px] w-[min-content]">
...
export default function Component() {
  return (
    <div className="bg-[#e8eef5] relative size-full" data-name="4">
      <Frame />
