...
import { imgClarakProfile2 } from "./svg-xgsad";
...
function Intro() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Intro">
      <p className="font-['Caveat:Bold',sans-serif] font-bold leading-[1.25] relative shrink-0 text-[#2d6383] text-[24px] tracking-[0.96px] w-full">Hi, my name is Clara. I’m good at making complex data feel friendly.</p>
...
export default function Component() {
  return (
    <div className="bg-[#e8eef5] relative size-full" data-name="5">
      <MaskGroup />
      <Frame />
