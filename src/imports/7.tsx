...
import { imgClarakProfile2 } from "./svg-vgw56";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[27px] items-end justify-center left-[524px] top-[102px] w-[611px]">
      <Intro />
      <UserResponse />
      <div className="font-['Roboto_Slab:Medium',sans-serif] font-medium leading-[1.25] min-w-full relative shrink-0 text-[16px] text-black tracking-[-0.48px] w-[min-content]">
...
export default function Component() {
  return (
    <div className="bg-[#E0E8F0] relative size-full" data-name="7">
      <Frame />
