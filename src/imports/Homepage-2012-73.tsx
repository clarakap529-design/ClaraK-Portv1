...
function Frame2() {
  return (
    <div className="bg-[#2d6383] content-stretch flex items-center justify-center px-[16px] py-[8px] relative rounded-[16px] shrink-0">
...
function Frame1() {
  return (
    <div className="absolute bg-[#c76129] content-stretch flex items-center justify-center left-[904px] px-[8px] py-[4px] rounded-[4px] top-[391px]">
...
export default function Homepage() {
  return (
    <div className="bg-[#E0E8F0] relative size-full" data-name="Homepage">
      <MaskGroup />
      <Frame />
      ...
      <Frame1 />
      <div className="absolute h-[30px] left-[860px] top-[357px] w-[82px]">
