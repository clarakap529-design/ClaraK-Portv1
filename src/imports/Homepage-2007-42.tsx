...
function Frame1() {
  return (
    <div className="absolute bg-[#c76129] box-border content-stretch flex gap-[10px] items-center justify-center left-[904px] px-[8px] py-[4px] rounded-[4px] top-[391px]">
